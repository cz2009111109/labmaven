...
public class PurchaseOrder {
	...
	public PurchaseOrder(int id, String purchaseid, String departmentname, String username, String applytime,
			String goodsname, String brands, String itemnumber, double catalogprice, double actualprice, double number,
			double price, String unitName, double norm, String function, String remark) {
		super();
		this.id = id;
	...
	public String toString() {
		return "PurchaseOrder [id=" + id + ", purchaseid=" + purchaseid + ", departmentname=" + departmentname
				...
				+ ", function=" + function + ", remark=" + remark + "]";
	}
